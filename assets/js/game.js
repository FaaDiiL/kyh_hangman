...
function guessLetter(e) {
  ...
  let hasUserAlreadyGuessedThisLetter = guessedLetters.includes(
  ...
  const indexOfFirst = selectableWords[currentWordIndex].indexOf(
    currentGuessedLetter
  )
  if (indexOfFirst > -1) {
    ...
    const indexOfSecond = selectableWords[currentWordIndex].indexOf(
      currentGuessedLetter,
      indexOfFirst + 1
    )
    if (indexOfSecond > -1) {
